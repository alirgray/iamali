...
<?php if (have_comments()) : ?>
    ...
    if (comments_open()) :
        ...
        comment_form(
                ...
                array('fields' => array(
                        ...
                        'author' => '<input id="author" name="author" type="text" placeholder="' . esc_html__('Name', 'park-wp') . '" value="' . esc_attr($commenter['comment_author']) . '" size="20"' . $aria_req . ' />',

                        'email' => '<input id="email" name="email" type="text" placeholder="' . esc_html__('Email', 'park-wp') . '" value="' . esc_attr($commenter['comment_author_email']) . '" size="20"' . $aria_req . ' />'

                    ),

                    'comment_field' => '<textarea id="comment" placeholder="' . esc_html__('Write Comment...', 'park-wp') . '" name="comment" cols="45" rows="12" aria-required="true"></textarea>',
                    ...
                    'label_submit' => esc_html__('Send', 'park-wp')));
    ...
    <?php if ($comment->comment_approved == '0') : ?>
                    ...
                    <em><?php echo esc_html__('Your comment is awaiting moderation.', 'park-wp'); ?></em>
