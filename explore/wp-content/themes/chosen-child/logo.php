...
if ( $image ) {
	...
	$logo = "<img class='logo' src='" . esc_url( get_theme_mod( 'logo_upload' ) ) . "' alt='" . esc_attr( $image_alt ) . "' />";
...
$output .= "<h1>" . esc_html( get_bloginfo( 'name' ) ) . "<span class='visually-hide'>:</span>" . "<span class='tagline'>" . esc_html( get_bloginfo( 'description' ) ) . "</span>" . "</h1>";
